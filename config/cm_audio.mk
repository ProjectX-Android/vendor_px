...
ALARM_PATH := vendor/px/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/px/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/px/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/px/prebuilt/common/media/audio/ui
